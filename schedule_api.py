...
def get_schools():
    '''
    Once a term is choosen, returns a list of valid schools
    Each item in the list is a dictionary containg:
        ('SchoolCode', 'SchoolDescr', 'SchoolShortDescr')
    '''
    from get_terms import TermCode
    if Termcode=='2010': #returns schools for FA 2014
        return get_data('/Curriculum/SOC/v1/Terms/2010/Schools')['getSOCSchoolsResponse']['School']
    if TermCode=='2020':  #returns schools for WN 2015
        return get_data('/Curriculum/SOC/v1/Terms/2020/Schools')['getSOCSchoolsResponse']['School']
